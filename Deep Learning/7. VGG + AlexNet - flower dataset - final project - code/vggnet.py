...
class vggnet:
    def __init__(self, path):
        self.batch_size = 64
        self.dwindle_rage = 4
        self.learnning_rate = 0.0002
        self.epoch = 70
        self._layer_1_convs = int(64 / self.dwindle_rage)
        self._layer_2_convs = int(128 / self.dwindle_rage)
        self._layer_3_convs = int(256 / self.dwindle_rage)
        self._layer_4_convs = int(512 / self.dwindle_rage)
        self._layer_5_convs = int(512 / self.dwindle_rage)
    ...
    def _network(self, x, is_pretrain=True):
        with tf.name_scope("VGG16"):
            x = self._conv("conv1_1", x, self._layer_1_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv1_2", x, self._layer_1_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            with tf.name_scope("pool1"):
                x = self._pool("pool1", x, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

            x = self._conv("conv2_1", x, self._layer_2_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv2_2", x, self._layer_2_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            with tf.name_scope("pool2"):
                x = self._pool("pool2", x, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

            x = self._conv("conv3_1", x, self._layer_3_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv3_2", x, self._layer_3_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv3_3", x, self._layer_3_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            with tf.name_scope("pool3"):
                x = self._pool("pool3", x, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

            x = self._conv("conv4_1", x, self._layer_4_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv4_2", x, self._layer_4_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv4_3", x, self._layer_4_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            with tf.name_scope("pool4"):
                x = self._pool("pool4", x, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

            x = self._conv("conv5_1", x, self._layer_5_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv5_2", x, self._layer_5_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            x = self._conv("conv5_3", x, self._layer_5_convs, kernel_size=[3, 3], stride=[1, 1, 1, 1], is_pretrain=is_pretrain)
            with tf.name_scope("pool5"):
                x = self._pool("pool5", x, kernel=[1, 2, 2, 1], stride=[1, 2, 2, 1], is_max_pool=True)

            x = self._FC_layer("fc6", x, out_nodes=self._layer_6_full)
            x = self._batch_norm(x)
            x = self._FC_layer("fc7", x, out_nodes=self._layer_7_full)
            x = self._batch_norm(x)
